...
// src/testes/sessiones-controller.test.ts
...
var deliveryLogsController = new DeliveriesLogsController();
...
describe("SessionController", () => {
  ...
  it("should authenticate a and get access token", async () => {
    ...
    const sessionsResponse = await (0, import_supertest.default)(app).post("/sessions").send({
      email: "authtestuser@example.com",
      password: "password123"
    });
